...
// group that will hold the chart
var svg = d3
  .select("#scatter")
  .append("svg")
  .attr("width", svgWidth)
...
// function used for updating circles group with a transition to circles
...
d3.csv("assets/data/data.csv").then(function(myData, err) {
  ...
  var circlesGroup = chartGroup.selectAll("circle")
        ...
        //.text is used here because it would not run otherwise, it kept bumping into the original html .text
